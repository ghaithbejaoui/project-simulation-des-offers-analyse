-- SQL export from donnees_fictives_offres_telecom_300_clients.xlsx
-- Generated on 2025-12-22 14:11:02 UTC
...
CREATE TABLE offers (
  ...
  quota_minutes INT DEFAULT 0,
  quota_sms INT DEFAULT 0,
  quota_data_gb DECIMAL(10,2) DEFAULT 0,
  validity_days INT DEFAULT 30,
  fair_use_gb DECIMAL(10,2) DEFAULT 0,
  ...
  roaming_included_days INT DEFAULT 0,
...
CREATE TABLE options (
  ...
  data_gb DECIMAL(10,2) DEFAULT 0,
...
CREATE TABLE offer_options (
  ...
  CONSTRAINT fk_oo_offer FOREIGN KEY (offer_id) REFERENCES offers(offer_id),
  CONSTRAINT fk_oo_option FOREIGN KEY (option_id) REFERENCES options(option_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE customer_profiles (
  ...
  sms_avg INT DEFAULT 0,
  data_avg_gb DECIMAL(10,2) DEFAULT 0,
  night_usage_pct INT DEFAULT 0,
...
(2, 'Offer 2', 'POSTPAID', 34.83, 369, 528, 55.07, 30, 55.07, 0.127, 0.041, 0.3045, 13, 'PUBLISHED'),
(3, 'Offer 3', 'PREPAID', 21.55, 257, 1281, 15.4, 30, 15.4, 0.1462, 0.0725, 0.8005, 3, 'PUBLISHED'),
(4, 'Offer 4', 'POSTPAID', 21.75, 838, 1183, 57.81, 30, 57.81, 0.1168, 0.0777, 0.3932, 2, 'PUBLISHED'),
(5, 'Offer 5', 'POSTPAID', 27.58, 1033, 433, 43.3, 30, 43.3, 0.1071, 0.0406, 0.8494, 4, 'DRAFT'),
(6, 'Offer 6', 'PREPAID', 21.65, 220, 898, 8.36, 30, 8.36, 0.0575, 0.0578, 0.2258, 4, 'PUBLISHED'),
(7, 'Offer 7', 'PREPAID', 20.74, 635, 1346, 14.4, 30, 14.4, 0.0797, 0.0498, 0.2258, 1, 'PUBLISHED'),
...
(10, 'Offer 10', 'POSTPAID', 42.28, 1736, 1109, 56.5, 30, 56.5, 0.0728, 0.067, 0.2503, 11, 'PUBLISHED'),
...
(19, 'Offer 19', 'POSTPAID', 24.34, 1398, 1410, 29.69, 30, 29.69, 0.1145, 0.0638, 0.197, 3, 'RETIRED'),
(20, 'Offer 20', 'PREPAID', 5.75, 544, 325, 8.05, 30, 8.05, 0.1279, 0.0666, 0.3854, 2, 'RETIRED'),
(21, 'Offer 21', 'PREPAID', 15.3, 729, 549, 18.78, 30, 18.78, 0.0258, 0.0405, 0.9931, 0, 'DRAFT'),
(22, 'Offer 22', 'POSTPAID', 55.63, 496, 602, 46.32, 30, 46.32, 0.0611, 0.064, 0.6955, 13, 'PUBLISHED'),
(23, 'Offer 23', 'PREPAID', 19.94, 334, 561, 18.8, 30, 18.8, 0.036, 0.0682, 0.238, 4, 'PUBLISHED'),
(24, 'Offer 24', 'POSTPAID', 54.98, 633, 280, 31.72, 30, 31.72, 0.1211, 0.078, 0.5507, 2, 'PUBLISHED'),
(25, 'Offer 25', 'PREPAID', 9.59, 259, 307, 13.88, 30, 13.88, 0.0858, 0.0586, 0.623, 4, 'PUBLISHED'),
...
(29, 'Offer 29', 'PREPAID', 7.18, 265, 1667, 16.14, 30, 16.14, 0.089, 0.0524, 0.881, 2, 'PUBLISHED'),
(30, 'Offer 30', 'PREPAID', 12.48, 224, 1856, 13.39, 30, 13.39, 0.1328, 0.0418, 0.3231, 2, 'PUBLISHED'),
(31, 'Offer 31', 'POSTPAID', 52.66, 1926, 389, 14.66, 30, 14.66, 0.039, 0.0677, 0.3793, 7, 'PUBLISHED'),
(32, 'Offer 32', 'BUSINESS', 53.24, 3377, 1623, 73.04, 30, 73.04, 0.035, 0.0115, 0.1499, 12, 'PUBLISHED'),
(33, 'Offer 33', 'PREPAID', 16.82, 436, 1377, 8.48, 30, 8.48, 0.0856, 0.0713, 0.866, 4, 'PUBLISHED'),
...
(36, 'Offer 36', 'POSTPAID', 45.7, 378, 1309, 19.42, 30, 19.42, 0.0897, 0.046, 0.8718, 11, 'PUBLISHED'),
...
(40, 'Offer 40', 'POSTPAID', 54.43, 1158, 1854, 53.01, 30, 53.01, 0.0324, 0.0608, 0.176, 1, 'RETIRED'),
(41, 'Offer 41', 'PREPAID', 24.18, 177, 1611, 12.28, 30, 12.28, 0.1234, 0.0762, 0.328, 2, 'PUBLISHED'),
...
(48, 'Offer 48', 'PREPAID', 23.37, 390, 1489, 3.1, 30, 3.1, 0.1496, 0.0715, 0.3555, 3, 'DRAFT'),
(49, 'Offer 49', 'PREPAID', 24.98, 67, 1348, 13.35, 30, 13.35, 0.1366, 0.012, 0.3167, 3, 'PUBLISHED'),
(50, 'Offer 50', 'POSTPAID', 27.93, 362, 226, 55.94, 30, 55.94, 0.0247, 0.0104, 0.1465, 13, 'PUBLISHED'),
(51, 'Offer 51', 'POSTPAID', 29.54, 718, 1728, 14.01, 30, 14.01, 0.1406, 0.064, 0.7283, 10, 'DRAFT'),
(52, 'Offer 52', 'PREPAID', 9.04, 650, 271, 10.59, 30, 10.59, 0.1169, 0.0541, 0.866, 0, 'PUBLISHED'),
...
(55, 'Offer 55', 'POSTPAID', 42.9, 1003, 461, 76.22, 30, 76.22, 0.0951, 0.059, 0.6843, 8, 'RETIRED'),
...
(59, 'Offer 59', 'PREPAID', 20.75, 307, 1120, 9.2, 30, 9.2, 0.0669, 0.0459, 0.763, 2, 'DRAFT'),
...
(3, 'Option 3', 'SMS_ADDON', 1.09, 0.0, 0, 767, 30),
(4, 'Option 4', 'ROAMING', 12.45, 1.19, 70, 132, 30),
(5, 'Option 5', 'VOICE_ADDON', 9.67, 0.0, 159, 0, 7),
(6, 'Option 6', 'SMS_ADDON', 2.87, 0.0, 0, 1494, 30),
(7, 'Option 7', 'SMS_ADDON', 3.33, 0.0, 0, 1093, 30),
(8, 'Option 8', 'DATA_ADDON', 4.72, 10.98, 0, 0, 15),
(9, 'Option 9', 'DATA_ADDON', 4.16, 16.89, 0, 0, 30),
(10, 'Option 10', 'VOICE_ADDON', 8.71, 0.0, 594, 0, 30),
...
(15, 'Option 15', 'VOICE_ADDON', 5.95, 0.0, 345, 0, 7),
(16, 'Option 16', 'DATA_ADDON', 12.97, 13.11, 0, 0, 7),
(17, 'Option 17', 'SMS_ADDON', 5.02, 0.0, 0, 1232, 30),
(18, 'Option 18', 'DATA_ADDON', 6.77, 11.25, 0, 0, 30),
(19, 'Option 19', 'ROAMING', 14.65, 3.96, 87, 147, 30),
(20, 'Option 20', 'VOICE_ADDON', 9.28, 0.0, 252, 0, 15),
(21, 'Option 21', 'ROAMING', 11.81, 2.74, 174, 120, 15),
(22, 'Option 22', 'VOICE_ADDON', 9.34, 0.0, 152, 0, 15),
(23, 'Option 23', 'DATA_ADDON', 6.41, 4.64, 0, 0, 15),
(24, 'Option 24', 'DATA_ADDON', 14.06, 9.52, 0, 0, 15),
(25, 'Option 25', 'VOICE_ADDON', 2.06, 0.0, 253, 0, 15),
(26, 'Option 26', 'SMS_ADDON', 4.8, 0.0, 0, 561, 30),
(27, 'Option 27', 'SMS_ADDON', 3.87, 0.0, 0, 1476, 30),
(28, 'Option 28', 'ROAMING', 19.41, 4.83, 159, 135, 30),
(29, 'Option 29', 'ROAMING', 7.28, 3.8, 167, 104, 15),
(30, 'Option 30', 'SMS_ADDON', 6.82, 0.0, 0, 919, 7),
(31, 'Option 31', 'DATA_ADDON', 11.54, 15.25, 0, 0, 30),
(32, 'Option 32', 'DATA_ADDON', 3.61, 1.78, 0, 0, 15),
(33, 'Option 33', 'VOICE_ADDON', 9.88, 0.0, 488, 0, 30),
(34, 'Option 34', 'LOYALTY', -3.35, 0.0, 0, 0, 15),
(35, 'Option 35', 'SMS_ADDON', 1.51, 0.0, 0, 488, 15),
(36, 'Option 36', 'ROAMING', 23.49, 4.2, 70, 36, 7),
(37, 'Option 37', 'DATA_ADDON', 3.42, 13.83, 0, 0, 15),
(38, 'Option 38', 'SMS_ADDON', 5.64, 0.0, 0, 210, 30),
(39, 'Option 39', 'SMS_ADDON', 5.81, 0.0, 0, 696, 7),
(40, 'Option 40', 'DATA_ADDON', 10.08, 17.3, 0, 0, 15);
...
(3, 'Client 3', 2492, 416, 89.48, 89, 4, 26.5, 'PRICE'),
...
(10, 'Client 10', 2553, 2166, 63.47, 98, 18, 36.0, 'BALANCED'),
...
(18, 'Client 18', 2531, 1898, 91.7, 31, 11, 47.73, 'PRICE'),
...
(23, 'Client 23', 1850, 427, 72.74, 4, 1, 67.2, 'PRICE'),
(24, 'Client 24', 3359, 2656, 38.61, 11, 2, 131.18, 'QUALITY'),
(25, 'Client 25', 1066, 2329, 147.7, 90, 12, 111.24, 'BALANCED'),
...
(34, 'Client 34', 3293, 1018, 74.1, 51, 9, 77.93, 'BALANCED'),
...
(43, 'Client 43', 1019, 2403, 23.7, 12, 15, 101.43, 'QUALITY'),
(44, 'Client 44', 2231, 1960, 109.2, 31, 14, 87.8, 'BALANCED'),
(45, 'Client 45', 1640, 264, 142.56, 47, 10, 84.18, 'QUALITY'),
(46, 'Client 46', 1232, 2959, 7.0, 84, 19, 106.4, 'BALANCED'),
(47, 'Client 47', 1601, 869, 80.18, 99, 15, 59.2, 'BALANCED'),
...
(55, 'Client 55', 2469, 2249, 94.2, 25, 1, 113.09, 'BALANCED'),
(56, 'Client 56', 1155, 1349, 4.46, 68, 10, 85.01, 'PRICE'),
(57, 'Client 57', 1430, 1119, 140.45, 44, 16, 60.78, 'BALANCED'),
(58, 'Client 58', 2996, 2128, 95.2, 48, 16, 89.54, 'QUALITY'),
(59, 'Client 59', 1202, 2865, 126.66, 92, 18, 94.6, 'BALANCED'),
(60, 'Client 60', 3424, 737, 72.61, 76, 12, 54.22, 'BALANCED'),
(61, 'Client 61', 1624, 1919, 39.41, 28, 9, 67.8, 'BALANCED'),
(62, 'Client 62', 2071, 1989, 129.22, 81, 11, 15.6, 'PRICE'),
(63, 'Client 63', 628, 1390, 126.04, 79, 4, 76.95, 'PRICE'),
(64, 'Client 64', 527, 390, 149.79, 39, 5, 27.32, 'PRICE'),
(65, 'Client 65', 714, 1233, 140.0, 61, 5, 75.57, 'QUALITY'),
...
(72, 'Client 72', 1487, 2157, 74.2, 80, 4, 46.51, 'BALANCED'),
(73, 'Client 73', 3130, 2751, 23.88, 9, 6, 40.4, 'BALANCED'),
...
(77, 'Client 77', 370, 1783, 113.1, 25, 4, 95.02, 'BALANCED'),
(78, 'Client 78', 1789, 962, 33.66, 36, 12, 130.12, 'QUALITY'),
(79, 'Client 79', 768, 2291, 27.27, 8, 3, 80.85, 'PRICE'),
(80, 'Client 80', 654, 2112, 21.44, 99, 19, 50.9, 'PRICE'),
...
(87, 'Client 87', 277, 1814, 97.3, 89, 15, 86.22, 'PRICE'),
(88, 'Client 88', 643, 2498, 140.4, 47, 9, 87.21, 'QUALITY'),
...
(95, 'Client 95', 3488, 233, 142.35, 32, 1, 134.5, 'QUALITY'),
(96, 'Client 96', 2040, 2413, 75.3, 97, 10, 92.67, 'PRICE'),
...
(103, 'Client 103', 1392, 2286, 39.36, 75, 10, 144.2, 'QUALITY'),
(104, 'Client 104', 2902, 358, 8.83, 66, 13, 101.4, 'QUALITY'),
(105, 'Client 105', 3312, 2767, 1.69, 57, 12, 89.43, 'BALANCED'),
(106, 'Client 106', 182, 295, 111.78, 2, 3, 109.71, 'QUALITY'),
(107, 'Client 107', 2989, 1383, 118.21, 0, 18, 140.3, 'QUALITY'),
...
(118, 'Client 118', 3411, 2972, 95.5, 87, 7, 69.49, 'BALANCED'),
...
(122, 'Client 122', 2929, 254, 85.55, 91, 14, 105.6, 'QUALITY'),
(123, 'Client 123', 1420, 557, 47.29, 96, 15, 37.88, 'PRICE'),
(124, 'Client 124', 703, 639, 130.23, 9, 2, 101.4, 'BALANCED'),
...
(128, 'Client 128', 1297, 2185, 117.2, 7, 14, 89.45, 'PRICE'),
...
(142, 'Client 142', 1527, 2323, 52.8, 63, 8, 88.75, 'BALANCED'),
...
(163, 'Client 163', 963, 933, 122.36, 67, 8, 37.1, 'PRICE'),
...
(183, 'Client 183', 2540, 1207, 96.1, 35, 13, 113.93, 'BALANCED'),
...
(188, 'Client 188', 1759, 2463, 5.6, 86, 16, 90.61, 'PRICE'),
...
(195, 'Client 195', 3230, 908, 14.41, 21, 3, 20.7, 'PRICE'),
...
(200, 'Client 200', 899, 2861, 128.61, 68, 17, 76.2, 'PRICE'),
(201, 'Client 201', 318, 2270, 103.65, 21, 13, 38.6, 'PRICE'),
...
(207, 'Client 207', 2188, 2879, 90.7, 52, 19, 75.75, 'QUALITY'),
...
(214, 'Client 214', 2981, 2190, 38.31, 28, 13, 61.6, 'PRICE'),
(215, 'Client 215', 956, 76, 79.49, 99, 6, 103.8, 'BALANCED'),
...
(235, 'Client 235', 2167, 1932, 23.88, 57, 13, 76.0, 'QUALITY'),
(236, 'Client 236', 2602, 591, 71.4, 84, 14, 59.98, 'BALANCED'),
...
(241, 'Client 241', 569, 2580, 11.62, 33, 8, 95.3, 'BALANCED'),
...
(272, 'Client 272', 1114, 2784, 115.74, 99, 0, 67.5, 'PRICE'),
...
(279, 'Client 279', 3395, 1755, 22.17, 83, 18, 48.6, 'BALANCED'),
...
(289, 'Client 289', 2305, 1364, 142.53, 9, 17, 105.1, 'BALANCED'),
